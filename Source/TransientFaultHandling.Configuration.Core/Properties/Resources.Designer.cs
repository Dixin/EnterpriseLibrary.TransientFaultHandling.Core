...
namespace Microsoft.Practices.EnterpriseLibrary.TransientFaultHandling.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The specified configuration file {0} is not supported..
        /// </summary>
        internal static string ConfigurationFileNotSupported {
            get {
                return ResourceManager.GetString("ConfigurationFileNotSupported", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The specified configuration key {0} cannot be found..
        /// </summary>
