namespace Microsoft.Practices.EnterpriseLibrary.TransientFaultHandling
{
    ...
    public sealed class ReliableSqlConnection : IDbConnection, ICloneable
    {
        ...
        public T ExecuteCommand<T>(IDbCommand command) => 
            this.ExecuteCommand<T>(command, this.CommandRetryPolicy, CommandBehavior.Default);
        ...
        public T ExecuteCommand<T>(IDbCommand command, RetryPolicy retryPolicy) => 
            this.ExecuteCommand<T>(command, retryPolicy, CommandBehavior.Default);
        ...
        object ICloneable.Clone() => new ReliableSqlConnection(this.ConnectionString, this.ConnectionRetryPolicy, this.CommandRetryPolicy);
