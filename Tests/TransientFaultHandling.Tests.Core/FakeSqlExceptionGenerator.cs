namespace Microsoft.Practices.EnterpriseLibrary.TransientFaultHandling.Tests
{
    ...
    internal static class FakeSqlExceptionGenerator
    {
        ...
        public static SqlException GenerateFakeSqlException(int errorCode)
        {
            ...
            return (SqlException)Activator.CreateInstance(typeof(SqlException), BindingFlags.NonPublic | BindingFlags.Instance, null, new object[] { string.Empty, collection, null, Guid.Empty }, null);
        }
        ...
        public static SqlException GenerateFakeSqlException(int errorCode, string errorMessage)
        {
            ...
            return (SqlException)Activator.CreateInstance(typeof(SqlException), BindingFlags.NonPublic | BindingFlags.Instance, null, new object[] { errorMessage, collection, null, Guid.Empty }, null);
        }
