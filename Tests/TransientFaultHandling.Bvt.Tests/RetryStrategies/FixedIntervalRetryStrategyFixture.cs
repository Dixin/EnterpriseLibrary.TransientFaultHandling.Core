namespace Microsoft.Practices.EnterpriseLibrary.TransientFaultHandling.Bvt.Tests.RetryStrategies
{
    ...
    public class FixedIntervalRetryStrategyFixture
    {
        ...
        {
            RetryPolicy<MockErrorDetectionStrategy> policy = this.retryManager.GetRetryPolicy<MockErrorDetectionStrategy>("Fixed Interval, 5 retries");
        ...
        {
            RetryPolicy<MockErrorDetectionStrategy> policy = this.retryManager.GetRetryPolicy<MockErrorDetectionStrategy>("Fixed Interval, 5 retries, first retry is fast");
        ...
        {
            RetryPolicy<MockErrorDetectionStrategy> policy = this.retryManager.GetRetryPolicy<MockErrorDetectionStrategy>("Fixed Interval, 5 retries, no fast retry");
        ...
        {
            RetryPolicy<MockErrorDetectionStrategy> policy = this.retryManager.GetRetryPolicy<MockErrorDetectionStrategy>("Fixed Interval, 5 retries in Milliseconds");
